...
enum {
	...
	AC_DISPLAY_SHOW_OFF,
	AC_DISPLAY_PRE_START_GAME,
	AC_DISPLAY_START_GAME,
	AC_DISPLAY_GAME_OVER,
};
...
/*****************************************************************************/
enum {
	AC_GAME_CONTROL_INITIAL = AK_USER_DEFINE_SIG,
	AC_GAME_CONTROL_PRE_PLAYING,
	AC_GAME_CONTROL_PLAYING,
	AC_GAME_CONTROL_NEW_ROUND,
};
...
/*****************************************************************************/
enum {
    AC_BALL_INITIAL = AK_USER_DEFINE_SIG,
    AC_BALL_PLAYING,
};
...
/*****************************************************************************/
enum {
    AC_BRICKS_INITIAL = AK_USER_DEFINE_SIG,
    AC_BRICKS_PLAYING,
    AC_BRICKS_EXPLODING,
};
...
/*****************************************************************************/
enum {
    AC_PADDLE_INITIAL = AK_USER_DEFINE_SIG,
    AC_PADDLE_PLAYING,
};
